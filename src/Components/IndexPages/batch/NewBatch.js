...
function NewBatch({ history }) {
  ...
  let validationSchema = yup.object().shape({
    ...
    // trainer_id: yup.string().required("Select Trainer").oneOf(trainerOptions),
    trainer_id: yup.string().required("Select Trainer"),
    no_of_students: yup.number().positive("Number can not start with minus sign").required("Input number of students")
  });
      ...
      <div className="formComponent">
        ...
        <Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={onSubmit}>
          <Form>
            ...
            <div className="form-group">
              <Field name="trainer_id" as="select" >
